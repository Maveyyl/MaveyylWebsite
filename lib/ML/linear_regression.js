var linear_regression = (function(){ 
	...
	function run( X, y, options ){
		...
		var i = 1;
		while( Math.abs(cost1-cost(X,y,theta)) > options.stop_condition && i < options.max_iter){ // stops when J decreased by less than stop_condition or if max_iter has been reached
